...
export default function FeatureGrid() {
  return (
    <section aria-label="Explore possibilities" className="w-full bg-white px-4 py-12">
      <div className="mx-auto max-w-7xl">
        ...
        <StaggerContainer className="feature-grid">
          <StaggerItem className="feature-card card1" style={{ background: "var(--color-accent-50)" }}>
            ...
            <div className="hidden md:block absolute left-6 top-10" style={{ width: 160, height: 160, transform: "rotate(-12deg)" }}>
              <div className="relative w-full h-full">
                <Image src="/decors/image 10.png" alt="Sticker sheet" fill className="object-contain" />
              </div>
            </div>
            <div className="hidden md:block absolute right-8 top-1/2 -translate-y-1/2" style={{ width: 170, height: 170, transform: "rotate(4deg)" }}>
              <div className="relative w-full h-full">
                <Image src="/decors/image 9.png" alt="Pattern sheet" fill className="object-contain" />
              </div>
            </div>
            <div className="hidden md:block absolute left-5 bottom-16" style={{ width: 340, height: 100 }}>
              <div className="relative w-full h-full">
          ...
          <StaggerItem className="feature-card card2" style={{ background: "var(--hi-pink)" }}>
            ...
            <div className="hidden md:block absolute right-40 -top-6" style={{ width: 160, height: 160, transform: "rotate(-10deg)" }}>
              <div className="relative w-full h-full">
                <Image src="/decors/image 11.png" alt="Charm sheet 1" fill className="object-contain" />
              </div>
            </div>
            <div className="hidden md:block absolute right-20 top-10" style={{ width: 170, height: 170, transform: "rotate(8deg)" }}>
              <div className="relative w-full h-full">
          ...
          <StaggerItem className="feature-card card3" style={{ background: "var(--hi-green)" }}>
            ...
            <div className="hidden md:block absolute left-10 top-0" style={{ width: 160, height: 160 }}>
              <div className="relative w-full h-full">
          ...
          <StaggerItem className="feature-card card4" style={{ background: "var(--warning-50, #fef3c7)" }}>
            ...
            <div className="hidden md:block absolute left-8 bottom-12" style={{ width: 180, height: 120 }}>
              <div className="relative w-full h-full">
